...
class win_addr:
    def __init__(self):
        ...
        self.button1 = Button(self.win1, text="Add", bg="darkblue", fg="white",
                              command=lambda: self.make_address(self.entry1.get()))
...
class win_d:
    def __init__(self):
        ...
        but2 = Button(self.win, text="Login", bg="darkblue", fg="white",
                      command=lambda: self.auth(ent1.get(), ent2.get()))
